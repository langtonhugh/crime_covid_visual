...
# file_names <- paste("data/met_police_april2017_to_march2020/", list.files("data/met_police_april2017_to_march2020", "*.csv", recursive=TRUE), sep = "")
...
# Download missing 2017 months (Jan-March). Note that it takes a while.
# download.file(url = "https://data.police.uk/data/archive/2017-04.zip", destfile = "data/archive_to_apr_2017.zip")
